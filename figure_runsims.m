...
%This part takes 12 minutes to run
tic

gflag = 0; % don't show graphics

%Inputs for ide_herb_fxm
%plant inputs
var_0 = 0.5;     % dispersal variance
...
delta_vec_neg = linspace(0,-var_0,11);


% get baseline speed for comparison
mu_g = 0; mu_a = 0; mu_s = 0; delta = 0;
[speed_inst_s,~,~,~,~,~] = ide_herb_fxn(var_0,sigma_s,sigma_a,gamma,phi,mu_g,mu_a,mu_s,delta,gflag);
